...
Skills:
	- Passive: Mountain King
		- Upon spawning, summon two Stone Golems. 
			- If Blazing, summon two Blazing Wisps instead.
			- If Overloading, summon a row of Overloading Jellyfish instead.
	- Primary: Colossal Clap
		- Clap towards the nearest enemy for 100% damage. Summon a Stone Golem. Can aim high or low.
			- If Blazing, summon a Blazing Wisp instead.
			- If Overloading, summon an Overloading Jellyfish instead.
	- Secondary: Stone Overcut
		- Throw an overhand punch downwards for 100% damage. Only use when an enemy is above center point. If enemy is above center point, spike downwards. If enemy is below center point, deal 25% damage instead.
	- Utility: Earthquake
