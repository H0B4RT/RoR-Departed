...
Key Notes
	- DEPARTED CONTENT
	- TBD
	- An unserious suggestion turned into a concept, and I'm actually quite satisfied with this.
	- Speeds towards the player, runs in circles around them, and fires a flamethrower towards them.
	- Can Walk and Jump
	- Is a Ranged Enemy
	- Concept by DigBug & Cute Robo
...
Type: Champion Enemy
Skills:
	- Primary: Bound Flamethrower
		- Charge up for 2 seconds, then release a melee-ranged flamethrower dealing 10x50% damage for as long as an enemy is within range.
