...
Skills:
	- Passive: Immovable
		- Your shield blocks all damage that hits it
	- Primary: Riot Shotgun
		- Fire a short range blast for 160% damage, hitting all enemies within its radius.
	- Secondary: Shield Slam
		- Smash nearby enemies for 210% damage, knocking them back.
